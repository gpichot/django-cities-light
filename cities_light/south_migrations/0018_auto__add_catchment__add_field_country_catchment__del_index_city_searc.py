...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cities_light_catchment', (
        ...
        db.send_create_signal(u'cities_light', ['Catchment'])

        # Adding field 'Country.catchment'
        db.add_column(u'cities_light_country', 'catchment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities_light.Catchment'], null=True),
                      keep_default=False)

        # Removing index on 'City', fields ['search_names']
        #db.delete_index(u'cities_light_city', ['search_names'])


    def backwards(self, orm):
        # Adding index on 'City', fields ['search_names']
        #db.create_index(u'cities_light_city', ['search_names'])

        # Deleting model 'Catchment'
        db.delete_table(u'cities_light_catchment')

        # Deleting field 'Country.catchment'
        db.delete_column(u'cities_light_country', 'catchment_id')


    models = {
        u'cities_light.catchment': {
            'Meta': {'ordering': "['name']", 'object_name': 'Catchment'},
        ...
        u'cities_light.country': {
            ...
            'alternate_names': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'catchment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.Catchment']", 'null': 'True'}),
